 ...
 * Time: 10:53
 */
public class LeftCloseRightMaxInterval extends AbstractInterval {
    protected static final String TAG = "LeftCloseRightMaxInterval";

    public LeftCloseRightMaxInterval(Double leftDigital) {
        super(IntervalEnum.getByCodde(IntervalEnum.LEFT_CLOSE_RIGHT_MAX.getCode())
                , leftDigital, Double.MAX_VALUE);
    }

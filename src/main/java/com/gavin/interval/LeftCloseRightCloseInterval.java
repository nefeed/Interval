 ...
 * Time: 10:53
 */
public class LeftCloseRightCloseInterval extends AbstractInterval {
    protected static final String TAG = "LeftCloseRightMaxInterval";

    public LeftCloseRightCloseInterval(Double leftDigital, Double rightDigital) {
        super(IntervalEnum.getByCodde(IntervalEnum.LEFT_CLOSE_RIGHT_CLOSE.getCode()),

 ...
 * Time: 10:53
 */
public class LeftCloseRightOpenInterval extends AbstractInterval {
    protected static final String TAG = "LeftCloseRightMaxInterval";

    public LeftCloseRightOpenInterval(Double leftDigital, Double rightDigital) {
        super(IntervalEnum.getByCodde(IntervalEnum.LEFT_CLOSE_RIGHT_OPEN.getCode())

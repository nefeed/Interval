 ...
 * Time: 10:53
 */
public class LeftMinRightCloseInterval extends AbstractInterval {
    protected static final String TAG = "LeftCloseRightMaxInterval";

    public LeftMinRightCloseInterval(Double rightDigital) {
        super(IntervalEnum.getByCodde(IntervalEnum.LEFT_MIN_RIGHT_CLOSE.getCode()),

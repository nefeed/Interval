 ...
 * Time: 10:53
 */
public class LeftOpenRightCloseInterval extends AbstractInterval {
    protected static final String TAG = "LeftCloseRightMaxInterval";

    public LeftOpenRightCloseInterval(Double leftDigital, Double rightDigital) {
        super(IntervalEnum.getByCodde(IntervalEnum.LEFT_OPEN_RIGHT_CLOSE.getCode()),
